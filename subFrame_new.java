...
public class subFrame extends JFrame {
	...
	public subFrame(int kolej, int l_cial, int l_czlon) {
...
/*
			if(i%4==0) {
				...
				panelList.add(new JPanel());
				panelList.get(i-1).add(labelWykList.get(k));
				mainpanelList.get(k).add(panelList.get(i-1));
			}else {
				mainpanelList.get(k).add(textFieldList.get(i/2));
			} 
*/
